...
description: Requires proof before marking work complete — no "trust me, it works". Ensures every change is verified with empirical evidence from tool outputs, screenshots, or logs.
---
...
*Part of GSD methodology. Evidence before assertions always.*