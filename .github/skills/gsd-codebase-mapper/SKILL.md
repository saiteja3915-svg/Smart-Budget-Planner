...
description: Analyzes existing codebases to understand structure, patterns, and technical debt. Produces ARCHITECTURE.md and STACK.md as systematic mapping documentation.
---

# GSD Codebase Mapper

## Overview
Analyzes existing codebases to produce documentation that enables informed planning.
